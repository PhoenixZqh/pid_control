...
if("TRUE" STREQUAL "TRUE")
  set(pid_SOURCE_PREFIX /home/pid_control/pid_lib)
  set(pid_DEVEL_PREFIX /home/pid_control/pid_lib/build/devel)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pid' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pid_control/pid_lib/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/pid_control/pid_lib/build/devel/lib;/opt/ros/noetic/lib)
